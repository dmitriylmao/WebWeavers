    ...
    <footer className={styles.footer}>
      <div className={styles.footerContainer}>
        ...
        <div className={styles.topSection}>
          <img src="/images/Footer/sultan_logo.svg" alt="Логотип" width="120" height="120" />
          <button className={styles.downloadButton}>Скачать прайс</button>
        </div>

        {/* Описание компании и подписка */}
        <p className={styles.description}>
          Компания «Султан» — снабжает розничные магазины товарами "под ключ" в Кокшетау и Акмолинской области.
        </p>
          ...
          <div className={styles.contactSection}>
            <div className={styles.footerColumn}>
              ...
              <div className={styles.paymentMethods}>
                <Image src="/images/Footer/visa_logo.svg" alt="Visa" width={40} height={30} />
                <Image src="/images/Footer/mastercard_logo.svg" alt="MasterCard" width={40} height={30} />
              </div>
            </div>
            ...
            <div className={styles.footerColumn}>
              ...
              <div className={styles.messengers}>
                <Image src="/images/Footer/whatsapp_logo.svg" alt="WhatsApp" width={30} height={30} />
                <Image src="/images/Footer/telegram_logo.svg" alt="Telegram" width={30} height={30} />
              </div>
